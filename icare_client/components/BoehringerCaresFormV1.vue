        ...
        <IRow>
          ...
          <IColumn xs="3">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_preferred_language_english">English</ICheckbox>
              <ICheckbox v-model="metadata.patient_preferred_language_spanish">Spanish</ICheckbox>
            </IFormGroup>
          </IColumn>
          <IColumn xs="3">
            <IFormGroup>
              <IFormLabel>Gender</IFormLabel>
              <ICheckbox v-model="metadata.patient_gender_male">Male</ICheckbox>
              <ICheckbox v-model="metadata.patient_gender_female">Female</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
        ...
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q1_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q1_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q2_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q2_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q3_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q3_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q4_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q4_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q5_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q5_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="12">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.patient_insurance_q6_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.patient_insurance_q6_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <hr />
        ...
        <IRow>
          ...
          <IColumn xs="4">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.rx_refill_1">1</ICheckbox>
              <ICheckbox v-model="metadata.rx_refill_2">2</ICheckbox>
              <ICheckbox v-model="metadata.rx_refill_3">3</ICheckbox>
            </IFormGroup>
          </IColumn>
        </IRow>
        <IRow>
          <IColumn xs="3">
            <IFormGroup>
              ...
              <ICheckbox v-model="metadata.medication_allergies_yes">Yes</ICheckbox>
              <ICheckbox v-model="metadata.medication_allergies_no">No</ICheckbox>
            </IFormGroup>
          </IColumn>
          <IColumn>
            <TextFieldInput
