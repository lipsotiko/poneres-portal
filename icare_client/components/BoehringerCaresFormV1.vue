  ...
  methods: {
    ...
    loadTestData() {
      this.$emit("loadTestData", {
        ...
        // patient_send_sms_notifications_yes: "Y",
        // patient_send_sms_notifications_no: "Y",
        patient_dob: "2023-01-02",
        patient_gender: "patient_gender_female",
        last_4_ssn: "1234",
        ...
        patient_insurance_q1: 'patient_insurance_q1_yes',
        patient_insurance_q2: 'patient_insurance_q2_no',
        patient_insurance_q3: 'patient_insurance_q3_yes',
        patient_insurance_q4: 'patient_insurance_q4_no',
        patient_insurance_q5: 'patient_insurance_q5_yes',
        patient_insurance_q6: 'patient_insurance_q6_no',
        patient_preferred_language: "patient_preferred_language_spanish",
        rx_refill: "rx_refill_3",
        medication_allergies: "medication_allergies_yes",
        drug_allergies: "some",
