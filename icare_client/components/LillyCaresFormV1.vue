    ...
    <IForm name="lilly_cares_v1">
      <IContainer>
        ...
        <IRow>
          <IColumn>
            <TextFieldInput
              v-model="metadata.infused_oncology_icd_10"
              name="infused_oncology_icd_10"
              label="Infused ONCOLOGY ICD 10 Code (for Alimta, Cyramza®, Erbitux®, & Portrazza® ONLY)"
            />
          </IColumn>
          <IColumn>
            <IFormGroup>
              <IFormLabel
                >INFUSED ONCOLOGY PRODUCT REPLACEMENT REQUEST</IFormLabel
              >
              <IRadioGroup
                v-model="metadata.infused_oncology_replacement_request"
                name="infused_oncology_replacement_request"
                :options="[
                  {
                    id: 1,
                    label: 'Alimta',
        ...
        <IRow>
          <IColumn>
            <TextFieldInput
              v-model="metadata.administration_date_1"
              name="administration_date_1"
          ...
          <IColumn>
            <TextFieldInput
              v-model="metadata.number_of_vials_1"
              name="number_of_vials_1"
              label="# of Vials"
            />
          </IColumn>
          <IColumn>
            <TextFieldInput
              v-model="metadata.vial_size_1"
              name="vial_size_1"
              label="Vial Size"
            />
          </IColumn>
        ...
        <IRow>
          <IColumn>
            <TextFieldInput
              v-model="metadata.administration_date_2"
              name="administration_date_2"
              label="Administration Date"
              type="date"
            />
          </IColumn>
          ...
          <IColumn>
            <TextFieldInput
              v-model="metadata.number_of_vials_2"
              name="number_of_vials_2"
              label="# of Vials"
            />
          </IColumn>
          <IColumn>
            <TextFieldInput
              v-model="metadata.vial_size_2"
              name="vial_size_2"
              label="Vial Size"
            />
          </IColumn>
        ...
        <IRow>
          <IColumn>
            <TextFieldInput
              v-model="metadata.administration_date_3"
              name="administration_date_3"
              label="Administration Date"
              type="date"
            />
          </IColumn>
          ...
          <IColumn>
            <TextFieldInput
              v-model="metadata.number_of_vials_3"
              name="number_of_vials_3"
              label="# of Vials"
            />
          </IColumn>
          <IColumn>
            <TextFieldInput
              v-model="metadata.vial_size_3"
              name="vial_size_3"
              label="Vial Size"
            />
          </IColumn>
  ...
  methods: {
    ...
    loadTestData() {
      this.$emit("loadTestData", {
        ...
        infused_oncology_icd_10: "M89.561",
        infused_oncology_replacement_request: 3,
        administration_date_1: "2023-12-12",
        administration_date_2: "2023-11-11",
        administration_date_3: "2023-10-10",
        dosage_1: "1",
        dosage_2: "2",
        dosage_3: "3",
        number_of_vials_1: "A",
