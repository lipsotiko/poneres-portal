            ...
            <div class="save">
              <div class="_display:flex _justify-content:space-between">
                ...
                <div v-if="!loading" class="right-buttons">
                  <IButton color="danger" @click="deleteModalVisible = true" :disabled="isNew" :loading="deleting">
                    Delete
                  </IButton>
...
const { schema: metaDataSchema, form: metadataForm, validate } = useForm({
...
const { schema: recipientsSchema, form: recipientsForm, validate: recipientsValidate } = useForm({
  recipients: [{
    name: fieldOptions,
...
const loadTestData = async () => {
  ...
  metaDataSchema.value.leasedAddress.value =
