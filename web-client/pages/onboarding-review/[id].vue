  ...
  <div class="mt-4">
    <div>
        <label class="font-medium">
            Are there any procedures/cases you are uncomfortable seeing/doing?
        </label>
        <p class="pl-2">{{ data.uncomfortableProcedures }}</p>
    </div>
    <div>
        <label class="font-medium">
            Have you ever done locums before? If so, when and where?
        </label>
        <p class="pl-2">{{ data.haveYouDoneLocumsBefore }}</p>
    </div>
    <div>
        <label class="font-medium">
            Do you have any active certifications? (i.e. BLS, ACLS, NRP, etc.)
        </label>
        <p class="pl-2">{{ data.activeCertifications }}</p>
    </div>
    <div>
        <label class="font-medium">
            Any dropped, pending or settled malpractice cases?
        </label>
